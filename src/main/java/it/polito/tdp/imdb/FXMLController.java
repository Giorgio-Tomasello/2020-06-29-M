...
public class FXMLController {
    ...
    void doCreaGrafo(ActionEvent event) {
    	...
    	txtResult.setText(model.creaGrafo(boxAnno.getValue()));
    	
    	boxRegista.getItems().addAll(model.getListaRegisti());
    ...
    void doRegistiAdiacenti(ActionEvent event) {
    	...
    	txtResult.appendText(model.getVicini(boxRegista.getValue()));
    ...
    void doRicorsione(ActionEvent event) {
    	...
    	int n = Integer.parseInt(txtAttoriCondivisi.getText());
    	txtResult.appendText("\n Ricorsione: \n" + model.getRicorsione(n, boxRegista.getValue()));
